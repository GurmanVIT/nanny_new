        ...
        <>
            ...
            <div className="baner_text_home d-flex align-items-center text-center">
                <div className="container">
                    ...
                    <h1 className="mb-3 pb-3">The <span>Nanny</span> Line
                    </h1>
                    <a href="#" className="btn btn-primary mt-4 all_btns px-4 py-2 position-relative">Book</a>
                </div>
            </div>
            <div className="who_we_section sections_padding">
                <div className="container text-center">
                    <h2>Who We Are?</h2>
                    <h1 className="my-5 pb-3">
                    ...
                    <div className="row">
                        <div className="col-md-8 offset-md-2">
                            ...
                            <a href="#" className="btn btn-primary d-inline-block mt-4 all_btns px-4 py-2 position-relative">Services</a><br />
                            <a href="#" className="btn btn-primary d-inline-block mt-4 all_btns px-4 py-2 position-relative">Apply to be Nanny</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div className="col-12 mb-4 ps-3 ps-md-5 mt-5 mt-md-0">
                                    <div className="d-flex flex-column flex-md-row align-items-center">
                                        ...
                                        <div className="service_info ps-0 ps-md-5">
                                            <h4 className="mb-3 fw-700">Occasional bookings</h4>
                    ...
                    <div className="row mt-5">
                        <div className="col-sm-6 col-lg-3 mb-3">
                            <div className="services_box secondry_bg pb-5 px-4 h-100">
                                ...
                                <h3 className="mb-4 fw-700">Full availability</h3>
                        ...
                        <div className="col-sm-6 col-lg-3 mb-3 why_2">
                            <div className="services_box secondry_bg pb-5 px-4  h-100">
                                ...
                                <h3 className="mb-4 fw-700">Experienced and professional</h3>
                        ...
                        <div className="col-sm-6 col-lg-3 mb-3 why_3">
                            <div className="services_box secondry_bg pb-5 px-4 h-100">
                                ...
                                <h3 className="mb-4 fw-700">Personally checked background</h3>
                        ...
                        <div className="col-sm-6 col-lg-3 mb-3 why_4">
                            <div className="services_box secondry_bg pb-5 px-4 h-100">
                                ...
                                <h3 className="mb-4 fw-700">Hotel availability</h3>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4 mb-4">
                            <div className="testimonials_box py-5 px-4">
                                <h4 className="mb-5 fw-700">“We had a lovely babysitter who was super cool with our daughter and her group of friends.”</h4>
                                <hr />
                                <div className="d-flex pt-4 align-items-center justify-content-between">
                                    <div className="d-block">
                                        <h5 className="fw-700">Astrid Aafjes</h5>
                                        <h6>TNL Mom</h6>
                                    </div>
                        ...
                        <div className="col-12">
                            <div className="row pt-5 px-4 align-items-center">
                                <div className="col-sm-2">
                                    <div className="d-flex testimonials_box py-5 px-4 align-items-center justify-content-center">
                                        <div className="d-block">
                                            <h5 className="fw-700">Astrid Aafjes</h5>
                                            <h6>TNL Mom</h6>
                                        </div>
                                ...
                                <div className="col-sm-9 offset-md-1">
                                    ...
                                    <h4 className="fw-700">“We had a lovely babysitter who was super cool with our daughter and her group of friends.”</h4>
                                </div>
                            </div>
                            <div className="row pt-5 px-4 flex-row-reverse align-items-center">
                                <div className="col-sm-2">
                                    <div className="d-flex testimonials_box py-5 px-4 align-items-center justify-content-center">
                                        <div className="d-block">
                                            <h5 className="fw-700">Astrid Aafjes</h5>
            ...
            <div className="prtners sections_padding">
                <div className="container">
                    <h1 className="text-center fw-700 mb-4 pb-3">
