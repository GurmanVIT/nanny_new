...
const Services = () => {
    return (
        <>
            <div class="services_banner inner_pages_banner position-absolute top-0 start-0"></div>
            ...
            <div class="sections_padding mt-5">
                <div class="container">
                    <h1 class="text-center mb-4 pb-3">
                        <span class="position-relative">What do we offer exactly?</span>
                    </h1>
                    <p class="text-center">During all of our services we aim to provide the best possible service to our customers</p>
                    <div class="row mt-5">
                        <div class="col-md-7 offset-md-1 pe-0">
                            <img class="w-100 my-5" src={service_holiday} alt="image" />
                        </div>
                        <div class="col-md-3 service_text secondry_bg">
                            <div class="p-5">

                                <h2 class="mb-4 fw-700">Hotel Booking</h2>
                                ...
                                <a href="#" class="btn btn-primary d-inline-block mt-4 all_btns px-4 py-2 position-relative">Boook Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-5 flex-row-reverse">
                        <div class="col-md-7 ps-0">
                            <img class="w-100 my-5" src={service} alt="image" />
                        </div>
                        <div class="col-md-3 offset-md-1 service_text secondry_bg ">
                            <div class="p-5">
                                <h2 class="mb-4 fw-700">Hotel Booking</h2>
                                <p>Are you on holiday in Barcelona? Do you want some free, quality time to go around and discover the beauty of the city by day or night? We suggest a holiday nanny to accompany you during your holiday. She might have some tips for family restaurants or nice places to visit. And you can have a nice dinner while your children are in the good hands of our babysitters. Our Holiday nannies cost €20.00 per hour including agency fee and VAT.​</p>
                                <a href="#" class="btn btn-primary d-inline-block mt-4 all_btns px-4 py-2 position-relative">Boook Now</a>
            ...
            <div class="wny_us sections_padding">
                <div class="container">
                    <h1 class="pb-3 mb-4 text-center">
                        <span class="position-relative">Extra services
                        </span>
                    </h1>
                    <p class="text-center">Besides regular babysitting, The Nanny Line offers a special range of nanny-services. Meet with the new concept of babysitting!</p>
                    <div class="row mt-5">
                        <div class="col-sm-6 col-lg-3 mb-3">
                            <div class="service_text secondry_bg pb-5 px-4 h-100">
                                <div class="choose_icon mb-5 d-inline-block">
                                    <i class="fas fa-chalkboard-teacher"></i>
                                </div>
                                <h3 class="mb-4 fw-700">Tutoring nanny</h3>
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3 why_2">
                            <div class="service_text secondry_bg pb-5 px-4 h-100">
                                <div class="choose_icon mb-5 d-inline-block">
                                    <i class="fas fa-share"></i>
                                </div>
                                <h3 class="mb-4 fw-700">Nanny sharing</h3>
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3 why_3">
                            <div class="service_text secondry_bg pb-5 px-4  h-100">
                                <div class="choose_icon mb-5 d-inline-block">
                                    <i class="fas fa-hourglass-start"></i>
                                </div>
                                <h3 class="mb-4 fw-700">Part-time & Long-term bookings</h3>
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3 why_4">
                            <div class="service_text secondry_bg pb-5 px-4 h-100">
                                <div class="choose_icon mb-5 d-inline-block">
                                    <i class="fas fa-sack-dollar"></i>
                                </div>
                                <h3 class="mb-4 fw-700">Specially priced nanny</h3>
