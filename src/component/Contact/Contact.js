...
const Contact = () => {
    return (
        <>
            ...
            <div className="baner_text about_nanny_texts d-flex tutoring_inner_sec sections_padding pt-0 align-items-center text-center">
                <div className="container">
                    <h1 className='line_texts'>Contact Us</h1>
                </div>
            </div>
