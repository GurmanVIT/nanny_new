                ...
                <div className="mt-5">
                    <div className="d-flex mt-4 flex-wrap">
                        <div className="tutor_image p-5 d-flex align-items-center justify-content-center text-start position-relative">
                            <h1 className="display-1 fw-700">Every <br />possible<br />activity
                            </h1>
                        </div>
                        <div className="tutor_info px-3 py-5 px-lg-5">
                            <h3 className="fw-700 mb-5">The solution for COVID-19 #StayAtHome</h3>
                            <p className="fw-700 mb-4">Have fun and learn with our activities driven by one of our super nannies. Your children will be sharing this activities, playing and interacting, with children their same age.</p>
                            ...
                            <p className="fw-700 mb-4">The price for a tutor nanny is €6.00 per class per child for group sessions. A private class costs €15.00 for 40-60min.</p>
                        </div>
                    </div>
                </div>
            </div>
